...
class HookedResidualAttentionBlock(nn.Module):
    def __init__(self, d_model: int, n_head: int, attn_mask: torch.Tensor = None, block_index: int = None):
        super().__init__()
